  ...
  return (
    <div className="bg-[#F9FAFB] text-[#111827]">
      ...
      <section className="relative h-75 md:h-90 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#F97316]/90 to-[#FB923C]/80" />
      ...
      <div className="container mx-auto px-4 py-10 md:py-14">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <section className="bg-gradient-to-r from-[#FB923C]/10 to-[#F97316]/10 rounded-xl p-6 md:p-8 border border-[#FB923C]/20">
